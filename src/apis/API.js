var API = {
  getDashboard (email) {
    ...
    return fetch(`https://lessprice.in/api/dashboard/tracks/${email}`)
    .then((response) => response.json());
  },

  requestAppInstallation (data) {
    return fetch(`https://lessprice.in/mobile/register/ios`, {
  ...
  requestOTP (data) {
    return fetch(`https://lessprice.in/mobile/initiate`, {
      credentials: 'same-origin',
      method: 'post',
      headers: {
        'Accept': 'application/json',
  ...
  verifyOTP (data) {
    return fetch(`https://lessprice.in/mobile/verify`, {
      credentials: 'same-origin',
      method: 'post',
      headers: {
        'Accept': 'application/json',
